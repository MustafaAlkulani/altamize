                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active fade show user_fllower_list " id="frends">
                                        <ul id="UlSearchResult" class="nearby-contct">
                                            @if($usersCount==0)
                                                <p class="text-center" style="color: #00a7d0"> {{trans('social.thereisnoresult')}} </p>
                                            @endif
                ...
                beforsend: function () {
                    ...
                    if (data.status == true) {
                        if (data.users == '') {
                            ...
                            _this.remove();
                            _this_parent.append('<p class="text-center" style="color: #00a7d0"> {{trans("social.thereisnoresult")}} </p>')
