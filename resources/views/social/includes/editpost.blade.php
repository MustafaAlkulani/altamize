...
<div class="central-meta" ID="UpdatePostGropForm">
    <div class="new-postbox">
        ...
        <div class="newpst-input">
            {{--{!! Form::open(['url'=> surl('editpostgroup'),'id'=>"UpdatePostGropForm" ,'class'=>'create-post-form',/*'class'=>'dropzone', 'id'=>'my-awesome-dropzone',*/'files'=>true]) !!}--}}
            {!! Form::open(['url'=> $EditPostUrl,'id'=>"UpdatePostForm" ,/*'class'=>'dropzone', 'id'=>'my-awesome-dropzone',*/'files'=>true]) !!}
            ...
            <input type="hidden" name="group_id" value="{{$Cource_id}}">
            <input type="hidden" id="editPostGroupButtons_image_id" name="images_id[]" value="">
            {{--   <input type="hidden" id="editPostGroupButtons_image_path" name="images_path[]" value="">--}}
            ...
            <div class="attachments">
                <ul id="UpdatePostGropFormBottons">
                    ...
                    <li>
                        {{--<button  id="SaveNewPostGroup"  type="submitt">{{trans('social.Post')}}</button>--}}
                        {{--<button  id="SaveNewPostGroup"  type="submit">{{trans('social.Post')}}</button>--}}
