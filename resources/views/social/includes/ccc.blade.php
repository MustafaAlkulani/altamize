...
<head>
    ...
    {{--<link rel="stylesheet" href="Desing/social/css/style.css">--}}
    {{--<link rel="stylesheet" href="Desing/social/css/responsive.css">--}}
    {{--<link rel="stylesheet" href="Desing/social/css/osamaCss.css">--}}
    ...
    <link rel="stylesheet" href="{{url('/')}}/Desing/social/dropzone/basic.css">
    <link rel="stylesheet" href="{{url('/')}}/Desing/social/dropzone/dropzone.css">


    <link rel="stylesheet" href="{{url('/')}}/Desing/social/css/popus.css">

    <link rel="stylesheet" href="{{url('/')}}/Desing/social/sweetAlert2/dist/sweetalert2.css">


    {{--
        <link rel="stylesheet" href="{{url('/')}}/Desing/social/css/SSS.css">

    --}}

<!------- upload multi image------>
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/desing/social/multipleImage/h.css">
