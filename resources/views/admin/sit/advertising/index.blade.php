    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <a href="{{aurl('sit/advertising/create')}}">
                        <button class="btn btn-info" href="{{aurl('sit/advertising/create')}}">
                                ...
                                <tbody>
                                      ...
                                      @foreach ( $data as $role)
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="{{aurl('sit/advertising/'.$role->id.'/edit')}}" class="btn btn-info"> <i class="fa fa-edit"></i> </a>
                                              </td>
