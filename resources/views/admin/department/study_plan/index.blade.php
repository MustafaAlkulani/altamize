...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            {!! Form::open(['id'=>'form_data','url'=>aurl('department/'.$dep_id.'/study/destroy/all'),'method'=>'delete']) !!}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="alert alert-danger">
                      ...
                      <h3 > {{trans('admin.ask_delete_itme')}}  <span class="record_count"></span> ?</h3>
                      </div>
                  </div>
                </div>
...
@section('footer')
    <script>
        ...
        function JSalert(id){
            swal({   title: "هل تريد الحذف فعلا",
                ...
                function(isConfirm){
                    ...
                    if (isConfirm)
                    {//صفحة الحذف
                        window.location.assign('study/'+id+'/destroy')
                    }
                    else {
        ...
        function editjs(id) {
            ...
            window.location.assign('study/'+id+'/edit')
        }
    </script>
@endsection
