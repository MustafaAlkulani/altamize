...
<head>
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="{{url('/')}}/desing/admin/plugins/datatables/dataTables.bootstrap.css">
    ...
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{url('/')}}/desing/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{url('/')}}/desing/admin/plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{url('/')}}/desing/admin/plugins/daterangepicker/daterangepicker-bs3.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="{{url('/')}}/desing/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
    ...
    <!------- custom dashbord css------>
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/desing/admin/dist/css/myDashbord.css">


 <!-- sweet alert -->
    <script src="{{url('/')}}/desing/admin/plugins/sweetAlert/sweet.js"></script>
    <link rel="stylesheet" href="{{url('/')}}/desing/admin/plugins/sweetAlert/sweet.css">


    <script src="{{url('/')}}/desing/admin/dist/js/myfunction.js"></script>
@yield('header')
    <!-- Google Font -->
