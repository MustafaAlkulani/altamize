...
class StudentLevelDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.social.upgrade.user.btn.checkbox')
            ->addColumn('show', 'admin.social.upgrade.user.btn.show')
            ->rawColumns([
                'checkbox',
                'show',
            ]);
    ...
    {
        $data=Upgrade::findOrFail(\request('stape'));
