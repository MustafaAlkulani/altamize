...
class GroupMemberDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('isBlocked', 'admin.social.section.group.btn.isBlocked')
            ->addColumn('isAdmin', 'admin.social.section.group.btn.isAdmin')
            ->addColumn('useraccountable_type', 'admin.social.section.group.btn.useraccountable_type')
            ->rawColumns([
                'delete',
                'checkbox',
                'isBlocked',
