    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="form-group <?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
                <?php echo Form::label('title',trans('admin.title')); ?>

                <?php echo Form::text('title',$notice->title,['class'=>'form-control']); ?>
            ...
            <div class="form-group <?php echo e($errors->has('notification') ? ' has-error' : ''); ?>">
                ...
                <?php echo Form::textarea('notification',$notice->notification,['class'=>'form-control controlNewsBody' ,'rows'=>'4']); ?>
            ...
            <div class="form-group <?php echo e($errors->has('file') ? ' has-error' : ''); ?>">
                <?php echo Form::label('file','اضافة مرفق '); ?>
