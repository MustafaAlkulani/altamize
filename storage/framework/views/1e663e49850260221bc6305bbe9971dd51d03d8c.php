    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <a href="<?php echo e(aurl('sit/slider/create')); ?>">
                        <button class="btn btn-info" href="<?php echo e(aurl('sit/slider/create')); ?>">
                                ...
                                <tbody>
                                      ...
                                      <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="<?php echo e(aurl('sit/slider/'.$role->id.'/edit')); ?>" class="btn btn-info"> <i class="fa fa-edit"></i> </a>
                                              </td>
