                        ...
                        <div class="central-meta">
                            <div class="frnds"> .
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a class="active" href="#frends" data-toggle="tab">  <?php echo e(trans('social.IFollow')); ?>   </a> <span class="contFrinds1"><?php echo e(($fllowingUserCount)); ?></span></li>
                                    <?php endif; ?>

                                    <?php if($userInfo->Myfollow==true or social()->user()->id==$userPage_id ): ?>
                                            <li class="nav-item"><a class="" href="#frends2" data-toggle="tab">  <?php echo e(trans('social.MyFollow')); ?> </a> <span class="contFrinds2"><?php echo e(($myFllowingUserCount)); ?></span></li>
                                        <?php endif; ?>

                                        <?php if(social()->user()->id==$userPage_id): ?>
                                            <li class="nav-item"><a class="" href="#frends-req" data-toggle="tab">  <?php echo e(trans('social.users')); ?>  </a><span class="contFrinds1"><?php echo e(($usersCount)); ?></span></li>
                                        <?php endif; ?>


                                        <?php if(social()->user()->id==$userPage_id): ?>
                                            <li class="nav-item"><a class="" href="#frends-myReq" data-toggle="tab"> <?php echo e(trans('social.myRequest')); ?>  </a><span class="contFrinds2"><?php echo e(($fllowingMyRequestCount)); ?></span></li>
                                        <?php endif; ?>

                                        <?php if(social()->user()->id==$userPage_id): ?>
                                            <li class="nav-item"><a class="" href="#frends-yourReq" data-toggle="tab"> <?php echo e(trans('social.YourRequest')); ?>  </a><span class="contFrinds1"><?php echo e(($fllowingYourRequestCount)); ?></span></li>
                                        <?php endif; ?>
      ...
      $(document).on('click','.followingUser',function () {
        ...
        <?php if($userInfo->Myfollow==true or social()->user()->id==$userPage_id ): ?>
                ...
                if("<?php echo e($userPage_id); ?>"=="<?php echo e(social()->user()->id); ?>")
                {
                    ...
                    loadMoreFollowButton(0,"myReq",<?php echo e($userPage_id); ?>);
                    loadMoreFollowButton(0,"yourReq",<?php echo e($userPage_id); ?>);
