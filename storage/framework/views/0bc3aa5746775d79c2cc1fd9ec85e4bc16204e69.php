<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('admin.title',['titled'=>$title ,'icon'=>'ion ion-android-chat'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>


    <div class="box">

        <div class="box-body">
            <?php echo Form::open(['id'=>'form_data','url'=>aurl('users/destroy/all'),'method'=>'delete']); ?>
