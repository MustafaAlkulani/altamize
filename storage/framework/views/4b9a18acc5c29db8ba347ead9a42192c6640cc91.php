                                        ...
                                        <div class="frnds">
                                            <ul class="nav nav-tabs ">
                                                <li class="nav-item "><a <?php if($active2=="req1"): ?>class="active"
                                                                ...
                                                                class="ti-info-alt"></i> Basic Information</a></li>
                                                    ...
                                                    <div class="editing-info">
                                                        ...
                                                        <form method="post"
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <label class="control-label" for="input">display
                                                                    Name</label><i class="mtrl-select"></i>
                                                            </div>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <label class="control-label"
                                                                       for="input">daddress</label><i
                                                                        class="mtrl-select"></i>
                                                            </div>

                                                            <div class="form-group ">
                                                                <input type="text" value="<?php echo e($user->site); ?>" name="site"/>
                                                                <label class="control-label" for="input">site</label><i
                                                                        class="mtrl-select"></i>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label class="control-label" name="phone" for="input">Phone
                                                                    No.</label><i class="mtrl-select"></i>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label class="control-label" for="textarea">About
                                                                    Me</label><i class="mtrl-select"></i>
                                                            </div>
                                                        ...
                                                        <form method="post" id='formChangePassword'
                                                            ...
                                                            <div class="form-group">
                                                                <input type="password" name="new_password" id="input"
                                                                       required="required"/>
                                                                <label class="control-label" for="input">New
                                                                    password</label><i class="mtrl-select"></i>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="password" name="old_password"
                                                                       required="required"/>
                                                                <label class="control-label" for="input">Current
                                                                    password</label><i class="mtrl-select"></i>
                                                            </div>
                                                            ...
                                                            <div class="submit-btns">
                                                                ...
                                                                <button class="mtr-btn " id="buttonchangePassWord"
                                                                        type="button" name='update'><span>Update</span>
                                                                </button>
                                                            </div>
                                                        </form>
                                                    </div>
