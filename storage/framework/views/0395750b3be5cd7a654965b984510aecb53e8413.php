            ...
            <div class="col-md-8">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#activity" data-toggle="tab" aria-expanded="false">المواد
                                الدراسية</a></li>
                        <?php if($user->useraccountable_type == 'App\Student'): ?>
                        ...
                        <div class="tab-pane active" id="activity">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">المواد الدراسية الحالية </h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                        ...
                        <div class="tab-pane " id="settings">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <a href="<?php echo e(aurl('student/'.$user->id.'/edit')); ?>">
                                        ...
                                        <?php else: ?>
                                        <a href="<?php echo e(aurl('teacher/'.$user->id.'/edit')); ?>">
                                            <button type="button" class="btn btn-default btn-block btn-sm">تعديل البيانات
                                                الاساسية
                                            </button>
                                        </a>
