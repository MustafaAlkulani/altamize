                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane " id="activity2">
                            <div class="box-content ">
                                <div class="box-header ">
                                    <h3 class="box-title">المواد الدراسيةالمستوى :  <?php echo e($level); ?> </h3>
                                ...
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table class="table no-margin">
                                            ...
                                            <tbody>
                                            <?php $__currentLoopData = $dataStudy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td> <?php echo e($item->name_ar); ?></td>

                                                    <?php if(isset($item->studyCourse->id)): ?>
                                                        <td><i class="fa fa-check"> </i> </td>
                                                    <?php else: ?>
                                                        <td>
                                                        <td><a href="<?php echo e(asurl('/').'/course/'.$item->id.'/studyAdd'); ?>"> اضافة كورس </a></td>
                                                        </td>
                                                    <?php endif; ?>
                        ...
                        <div class="tab-pane " id="activity">
                            <div class="box-content ">
                                <div class="box-header ">
                                    <h3 class="box-title">الكورسات الدراسيةالمستوى  <?php echo e($level); ?>  والمجموعات المفعلة</h3>
