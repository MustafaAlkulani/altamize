                    ...
                    <div class="timeline-info">
                        ...
                        <ul>
                            ...
                            <li  style="direction:<?php echo e(trans('social.direction')); ?>;">
                                ...
                                <a style="margin-right:<?php echo e(trans('social.marginLastElement')); ?>" <?php if($active=="messenger2"): ?><?php echo e('class=active'); ?> <?php endif; ?> href="<?php echo e(surl('messenger2/'.social()->user()->id)); ?>"
                                title="messenger" data-ripple=""> <?php echo e(trans('social.Messenger')); ?> </a>
                            </li>
                        </ul>
                    </div>
                </div>
