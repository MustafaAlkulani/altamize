                    ...
                    <div class=" col-md-8 center-block ">
                        ...
                        <div class="box-footer with-border">
                            <div class="text-center  assignmentInfoBtn">
                                <button  class="btn btn-primary btn-block"  >  add file <i class="fa fa-plus"></i> </button>
                            </div>
                            ...
                            <div class="assignmentInfoText vv">
                                <form action="<?php echo e(surl('groupFile')); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="course_id" value="<?php echo e($Cource_id); ?>">
                            ...
                            <div class="box box-solid collapsed-box">
                                ...
                                <div class="box-body no-padding" >
                                    <ul class="nav nav-pills nav-stacked " style="display: block;">
                                        ...
                                        <?php if(count($files) >0): ?>
                                            ...
                                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <li class="row " style="alignment: left;">
                                                    ...
                                                    <div class="col-xs-6"> <a href="#" class="btn"> <?php echo e($file->originalName); ?>  </a> </div>


                                                    <div class="col-xs-3"> <a href="<?php echo e(surl('downloadGroupFile/'.$file->id)); ?>" class="btn">  <span class="fa fa-cloud-download "></span> </a></div>
                                                    <div class="col-xs-1">
                                                        <?php if( social()->user()->id==$file->user_id): ?>
                                                        <button href="<?php echo e(surl('editBook/GroupFile/'.$file->id)); ?>" book-id="info<?php echo e($file->id); ?>" info="<?php echo e($file->describtion); ?>" class="btn btn-info buttonUpdateBook"> <i class="fa fa-edit"></i>
                                                        </button>
                                                            <?php endif; ?>
                                                    </div>
                                                    
                                                    <?php if( social()->user()->id==$file->user_id  or isGroupAdmin(social()->user()->id,$Cource_id)==1): ?>
                                                    <button type="button"  class="btn btn-danger buttonDeleteBook "   book-id=" <?php echo e($file->id); ?>" , booktype="GroupFile" deleteMessage="do you want delete this file" > <i class="fa fa-trash"></i>  </button>
                                                    <?php endif; ?>
                                                    ...
                                                    <div  class="col-xs-12 assignmentInfoText vv "  >
                                                        <p> published at :  <span><?php echo e($file->created_at->diffForHumans()); ?> </span></p>
                                        ...
                                        <?php else: ?>
                                            <h4 class="text-center" style="color: #00a7d0"> there is no  any file </h4>
                                        <?php endif; ?>
