        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12" style="margin-top: 50px">
            <table class="table table-striped " style="direction:rtl; text-align: right">
                <tr>
                    ...
                    <th style="width:35%; text-align: right">  <?php echo e(trans('social.course')); ?> </th>
                    <th style="width:10%; text-align: right"> <?php echo e(trans('social.grade')); ?></th>
                    <th style="width:25%; text-align: right"> <?php echo e(trans('social.year')); ?></th>
                    <th style="width:10%; text-align: right"> <?php echo e(trans('social.maxGrade')); ?> </th>
                    <th style="width:10%; text-align: right"> <?php echo e(trans('social.rate')); ?></th>
                </tr>
