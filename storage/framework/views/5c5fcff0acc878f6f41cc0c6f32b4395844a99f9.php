                            ...
                            <div class="col-md-8 center-block">
                                <div class="central-meta">
                                            ...
                                            <li class="user-avatar">
                                                <?php if(social()->user()->id==$photo->user_id): ?>
                                                    <button  type="button" image_id="<?php echo e($photo->id); ?>"
                                                             type_image="personal" message="Do you want to dekete this photo"
                                                             
                                                             class="buttonDeleteImages btn btn-danger edit-phto " > <i class="fa fa-trash"></i>  </button>
                                                <?php endif; ?>

                                                <a class=" personal_photo strip " src="<?php echo e(Storage::url($photo->image)); ?>" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
                                    ...
                                    <div class="lodmore">
                                        ...
                                        <button id="Btn_cover" user-id="<?php echo e($userProfileId); ?>"  class="loadMoreImageButton btn-view btn-load-more" type_image="cover"   image-id="<?php echo e($Lastphoto); ?>" ></button>
                                    </div>
                                </div><!-- photos -->
                                ...
                                <div class="central-meta">
                                    ...
                                    <ul id="personalImages" class="photos">
                                        <?php $__currentLoopData = $personal_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li class="user-avatar">
                                                ...
                                                <a class="strip" src="<?php echo e(Storage::url($photo->image)); ?>" title="" data-strip-group="mygroup" data-strip-group-options="loop: false">
                                    ...
                                    <div class="lodmore">
                                        ...
                                        <button id="Btn_personal" user-id="<?php echo e($userProfileId); ?>" class="loadMoreImageButton btn-view btn-load-more"  type_image="personal"   image-id="<?php echo e($Lastphoto); ?>" ></button>
                                    </div>
                                </div><!-- photos -->
                                ...
                                <div class="central-meta">
                                    ...
                                    <div class="lodmore">
                                        ...
                                        <button id="Btn_post" class="loadMoreImageButton btn-view btn-load-more"  type_image="post" user-id="<?php echo e($userProfileId); ?>"  image-id="<?php echo e($Lastphoto); ?>" ></button>
                                    </div>
