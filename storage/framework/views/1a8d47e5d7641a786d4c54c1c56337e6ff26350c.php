...
<div class="central-meta item">
    <div class="user-post">
                ...
                <ul class="row">
                    ...
                    <li class="col-xs-3">
															<span class="like" data-toggle="tooltip" title="like">
                                                             <a href= "<?php echo e(surl('likepostpro/'.$post->id)); ?>" >
																 <i class="ti-heart"></i>
                                                                 </a>
																<ins>2.2k</ins>
															</span>
        ...
        <?php
        $comm=App\CoummentPostProfile::where('post_id',$post->id)->get();
        //print_r($comm);
        ?>

        <?php $__currentLoopData = $comm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div  id="post-comment" class="coment-area">
           ...
           <?php echo Form::open(['url'=>surl('replycommpostpro/'.$comment->id) ,'files'=>true]); ?>
