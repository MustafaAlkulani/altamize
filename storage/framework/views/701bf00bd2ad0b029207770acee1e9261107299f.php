            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="land-featurearea">
                    <div class="land-meta">
                        ...
                        <p><?php echo e(trans('social.loginMessage')); ?> </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="login-reg-bg">
                    <div class="log-reg-area sign">
                        <h2 class="log-title">   <?php echo e(trans('social.completeRigester')); ?>  </h2>
                        <p><span>   <?php echo e(trans('social.hello')); ?> </span>

                            <?php echo e($userAccount->dispaly_name); ?>


                        </p>
                        <form method="post" action="<?php echo e(surl('register2')); ?>">
                            <?php echo e(csrf_field()); ?>


                            <input type="hidden" name="id" value="<?php echo e($userAccount->id); ?>" id="input" required=""/>
                            ...
                            <div class="form-group">
                                <input type="email" name="email" value="<?php echo e($userAccount->useraccountable->email); ?>"
                                       id="input" required=""/>
                                <label class="control-label" for="input"> <?php echo e(trans('social.email')); ?>
                            ...
                            <div class="submit-btns">
                                <button class="mtr-btn " type="submit" name='register'><span> <?php echo e(trans('social.login')); ?></span></button>
                            </div>
                        </form>
                    </div>
