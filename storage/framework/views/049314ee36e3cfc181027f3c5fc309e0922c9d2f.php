                        ...
                        <div class="central-meta">
                            <div class="frnds"> .
                                <ul class="nav nav-tabs">
                                  <li class="nav-item"><a class="active" href="#frends" data-toggle="tab">  عدد النتائج  <?php echo e($usersCount); ?> نتيجة</a> </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active fade show user_fllower_list " id="frends" >
                                            ...
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    <div class="nearly-pepls">
                                                        <figure>
                                                            <a href="<?php echo e(surl('personalPage/'.$user->id)); ?>" title=""><img src="<?php echo e(Storage::url($user->personal_image)); ?>" alt=""></a>
                                                        </figure>
                                                        <div class="pepl-info">
                                                            <h4  style="width: 50%" ><a href="<?php echo e(surl('personalPage/'.$user->id)); ?>" title=""><?php echo e($user->display_name); ?></a></h4>
                                                            <span><?php if($user->useraccountable_type=="App\Teacher"): ?> <?php echo e($user->useraccountable->type); ?> <?php else: ?> Student <?php endif; ?></span>
                                                            <a href="#"   user_id="<?php echo e($user->id); ?>" title="" class="addGroupMember add-butn" data-ripple=""> اضافةxx </a>
                                        ...
                                        <div class="lodmore">
                                            ...
                                            <button id="loadMoreSearchMemberResult" class="loadMoreSearchMemberResult btn-view btn-load-more" searchWord="<?php echo e($searchWord); ?>" last-id="<?php echo e($last_id=$user->id); ?>" ></button>
    ...
    <script>
        ...
        $(document).on('click','.loadMoreSearchMemberResult',function () {
          ...
          var data='last_id='+encodeURIComponent($(this).attr('last-id') )+'&searchWord='+encodeURIComponent($(this).attr('searchWord') );
            var url='/social/loadMoreSearchMemberResult';
            //data=  data.serialize();
