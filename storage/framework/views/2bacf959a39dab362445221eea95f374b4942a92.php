            ...
            <div class="col-md-12 col-lg-4">
                ...
                <div class="p-30 mb-30 card-view">
                    ...
                    <ul class="list-contact list-li-mb-20">
                        <li><i class="ion-ios-home"></i> <?php echo getSetting('address'); ?></li>
                        <li><a href="#"><i class="ion-ios-telephone"></i><?php echo getSetting('phone'); ?></a></li>
                        <li><a href="#"><i class="ion-email"></i><?php echo getSetting('email'); ?></a></li>
                        <li class="mb-0"><a href="#"><i class="ion-ios-world"></i><?php echo getSetting('link'); ?></a></li>
                    </ul>
                </div><!-- card-view -->
            </div><!-- col-sm-12 -->
