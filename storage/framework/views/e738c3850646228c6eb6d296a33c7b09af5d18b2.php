...
<div class="side-panel">
    ...
    <form method="post">
        ...
        <div class="setting-row">
            <span><a href="<?php echo e(route('personalPages.setting')); ?>" onclick="pp(this)" title=""><i class="ti-settings"></i>account setting</a></span>
        </div>
        <div class="setting-row">
            <span><a href="<?php echo e(surl('logout')); ?>" onclick="pp(this)" title=""><i
                            class="ti-power-off"></i>log out</a></span>
        </div>
