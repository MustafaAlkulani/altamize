        ...
        <div class="container-fluid">
            ...
            <div class="row" id="page-contents">
                ...
                <div class=" col-md-8 center-block ">
                    ...
                    <?php if(isGroupAdmin(social()->user()->id,$groupInfo->id)==1): ?>
                        <div class="box-footer with-border">
                            <div class="text-center  assignmentInfoBtn">
                                <button class="btn btn-primary btn-block"> <?php echo e(trans('social.addMemeber')); ?><i class="fa fa-plus"></i>
                                </button>
                            </div>
                            ...
                            <div class="assignmentInfoText vv ">
                                ...
                                <div class="searched" style="width: 60%">
                                    <form method="get" action="<?php echo e(surl('searchGeoupMember')); ?>" class="">
                        ...
                        <div class="frnds">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item"><a class="" href="#frends-req" data-toggle="tab">
                                    <?php echo e(trans('social.BlockedMembers')); ?></a><span id="BlockCount" class="contFrinds2"><?php echo e($memberBlocked); ?></span></li>
                            </ul>
                                                    ...
                                                    <div class="nearly-pepls">
                                                        ...
                                                        <div class="pepl-info">
                                                            ...
                                                            <span><?php if($groupMember->pivot->isAdmin): ?>
                                                                     <?php echo e(trans('social.Admin')); ?>

                                                                <?php else: ?>
                                                                    <?php echo e(trans('social.User')); ?>
...
<?php $__env->startSection('footer'); ?>
    <script>
        ...
        $(document).on('click', '.btn_blocked', function () {
            ...
            var _this = $(this);
            var data = 'typeBlock=' + encodeURIComponent($(this).attr('typeBlock')) + '&user_id=' + encodeURIComponent($(this).attr('user_id')) + '&group_id=' + encodeURIComponent('<?php echo e($groupInfo->id); ?>');
        ...
        $(document).on('click', '.btn_deleteMember', function () {
            ...
            var data = 'user_id=' + encodeURIComponent($(this).attr('user_id')) + '&group_id=' + encodeURIComponent('<?php echo e($groupInfo->id); ?>');
