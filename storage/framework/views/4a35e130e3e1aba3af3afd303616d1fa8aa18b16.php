...
<div class="side-panel">
    ...
    <form method="post">
        ...
        <div class="setting-row">
            <span><a href="<?php echo e(route('personalPages.setting')); ?>" onclick="pp(this)" title="">
                    <i class="ti-settings"></i><?php echo e(trans('social.accountsetting')); ?></a></span>
        </div>
        <div class="setting-row">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.fail) {
                    ...
                    $('#preview_' + type).attr('src', '<?php echo e(Storage::url('')); ?>/' + data);
                }
