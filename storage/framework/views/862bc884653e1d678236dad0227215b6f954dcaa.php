...
<div class="central-meta item">
    <div class="user-post">
        <div class="friend-info ">
            ...
            <?php if(social()->user()->id == $post->user->id or ( isGroupAdmin(social()->user()->id, $post->group_id)==1 And $post->group_id!=0) ): ?>
                <div class="more"><big><big>...</big></big>
                    <ul class="more-dropdown">
                        <li>
                            <a class="buttonDeletePost" url='<?php echo e($deletePostUrl); ?>'
                               message="do you want to delete this post" type="Profile" post-id="<?php echo e($post->id); ?>"><?php echo e(trans('social.DeletePost')); ?><i
                        ...
                        <?php if(social()->user()->id == $post->user->id ): ?>
                            <li>
                                ...
                                <a post-id="<?php echo e($post->id); ?>" id="<?php echo e($post->id); ?>" class="buttonD"><?php echo e(trans('social.EditPost')); ?> </a>
                            </li>

                            <li>
                                <a href="#"><?php echo e(trans('social.TurnOffNotifications')); ?></a>
                            </li>
                            <li>
                                <a href="#"><?php echo e(trans('social.SelectasFeatured')); ?></a>
                            </li>
                        <?php endif; ?>
        ...
        <!-- end post options  -->
            ...
            <div class="friend-name">
                <ins><a href="<?php echo e(surl('personalPage/'.$post->user_id)); ?>"
                        title=""><?php if($post->group_id!=0): ?> <?php  $groupName = \App\Group::where('id', $post->group_id)->first(['name']);
                        ...
                        <li>
                            <a class="strip" href="<?php echo e(Storage::url($postimg->image)); ?>" title=""
                               data-strip-group="mygroup" data-strip-group-options="loop: false">
                                <img path=<?php echo e($postimg->image); ?> id="<?php echo e($postimg->id); ?>"
                                     src="<?php echo e(Storage::url($postimg->image)); ?>" alt=""></a>
                        </li>
            ...
            <div class="we-video-info postButtns">
                <ul class="row">
                    ...
                    <li class="col-xs-4">
            <span class="like" data-toggle="tooltip" title="<?php echo e(trans('social.like')); ?>">
            ...
            <span class="comment comments-button "
                  ...
                  post-id=<?php echo e($post->id); ?>
                          ...
                          title="<?php echo e(trans('social.Comments')); ?>" id="comments-button">
            <!-- <a href= "<?php echo e(surl('commentpost/')); ?>" > -->
                ...
                <ins><?php echo e($post->user_comments_count); ?></ins>
                    ...
                    <li class="col-xs-4">
            <span class="dislike" data-toggle="tooltip" title="<?php echo e(trans('social.dislike')); ?>">
                <a href="#" table_name="likePostProfile" likeType="post"
                   uid="<?php echo e(social()->user()->id); ?>"
                   post-id="<?php echo e($post->id); ?>" class=" UnactiveLike checkLike">
