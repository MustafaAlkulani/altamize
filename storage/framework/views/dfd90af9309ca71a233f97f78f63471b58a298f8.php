<?php $__env->startSection('content'); ?>
    ...
    <div class="box">
        ...
        <div class="box-body">
            <?php echo Form::open(['id'=>'form_data','url'=>aurl('contact/destroy/all'),'method'=>'delete']); ?>
...
<?php $__env->startPush('js'); ?>
  <script>
      ...
      function replaeConcatUs(id,message) {
          swal({
              ...
              inputPlaceholder: "اكتب اي رد"
          }, function (inputValue) {
              if (inputValue === false) return false;
              if (inputValue === "") {
                  swal.showInputError("انت لم تكتب اي شي !");
                  return false
              }
              window.location.assign('sendmel/'+id+'/'+inputValue)
          });
      }
