        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="box box-solid collapsed-box">
                            ...
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title"> <?php echo e($std); ?> </h3>
                            ...
                            <div class="box-body no-padding" >
                                <ul class="nav nav-pills nav-stacked " style="display: block;">
                                 ...
                                 <?php $__currentLoopData = $refer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     
                                
                                 

                                    <li class="row " style="alignment: left;">
                                    <?php  $type=explode('.',$ref->file) ;
                                      $file_name=str_slug( 'files').'.'.last($type);
                                      ?>
                                        <div class="col-xs-6"> <a href="#" class="btn"> <?php echo e($file_name); ?>  </a> </div>
