            ...
            <ul class="more-dropdown">
                <li>
                    ...
                    <a class="buttonUpdateComment" url="<?php echo e(surl('editComment/Profile/'.$comm->id)); ?>"
                       comment-id="CommentText<?php echo e($comm->id); ?>" info="<?php echo e($comm->text); ?>"><?php echo e(trans('social.Editcomment')); ?> <i class="fa fa-edit"
                ...
                <li>
                    <a class="buttonDeleteReplyComment" url='<?php echo e(surl("deleteComment/Profile/".$comm->id)); ?>'
                       ...
                       comment-id="CommentText<?php echo e($comm->id); ?>"> <?php echo e(trans('social.Deletecomment')); ?><i
            ...
            <li class="col-xs-3">
                <span class="comment replyCommentsButton"
                      comment-id=<?php echo e($comm->id); ?>
                              ...
                              data-toggle="tooltip" title="<?php echo e(trans('social.ReplyComments')); ?>"
