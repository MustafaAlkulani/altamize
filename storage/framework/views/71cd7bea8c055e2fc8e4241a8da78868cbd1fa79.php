                        ...
                        <div class="col-lg-4 col-xs-6">
                            ...
                            <div class="small-box <?php echo e($small_box[$counterForSmall_box]); ?>">
                                <div class="inner">
                                    ...
                                    <?php else: ?>
                                        <h2><?php echo e($myCource->name_en); ?></h2>
                                        <?php endif; ?>
                                    ...
                                    <p><SPAN>  <?php echo e(trans('social.referenceCount')); ?></SPAN> <SPAN><?php echo e($countRef); ?> </SPAN></p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-bag"></i>
                                </div>
                                <a class="small-box-footer" href="<?php echo e(surl('refer/'.$myCource->id)); ?>"> <?php echo e(trans('social.view')); ?>
