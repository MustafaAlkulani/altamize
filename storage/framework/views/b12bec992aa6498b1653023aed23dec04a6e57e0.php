                                                        ...
                                                        <li>
                                                            <div class="nearly-pepls">
                                                                ...
                                                                <div class="pepl-info">
                                                                    ...
                                                                    <a href="<?php echo e(surl('UnfollowUser/'.social()->user()->id.'/'.$user->id)); ?>" title="" class="add-butn more-action" data-ripple="">الغاء المتابعة</a>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <div class="nearly-pepls">
                                                                ...
                                                                <div class="pepl-info">
                                                                    ...
                                                                    <a href="<?php echo e(surl('following/'.social()->user()->id.'/'.$user->id)); ?>" title="" class="add-butn" data-ripple="">متابعة</a>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
