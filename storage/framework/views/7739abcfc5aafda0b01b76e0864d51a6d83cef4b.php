                ...
                <div class="login-reg-bg">
                    <div class="log-reg-area sign">
                        ...
                        <form method="post" action="<?php echo e(surl('register2')); ?>">
                            ...
                            <div class="form-group">
                                <input type="email"  name="email" value="<?php echo e($userAccount->useraccountable->email); ?>" id="input" required=""/>
                            ...
                            <div class="submit-btns">
                                <button class="mtr-btn "  type="submit" name='register' ><span>login</span></button>
                            </div>
                        </form>
                    </div>
