                        ...
                        <div class="row" id="page-contents">
                            ...
                            <div class="col-md-8 center-block">
                                <div class="central-meta">
                                    <h2 class="text-center"><?php echo e(trans('social.coverimages')); ?> </h2>
                                ...
                                <div class="central-meta">
                                    <h2 class="text-center">  <?php echo e(trans('social.profileimages')); ?></h2>
                                ...
                                <div class="central-meta">
                                    <h2 class="text-center"> <?php echo e(trans('social.Postsimages')); ?> </h2>
