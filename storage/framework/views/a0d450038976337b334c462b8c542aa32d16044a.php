                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active fade show " id="req1" >
                                                    <div class="editing-info">
                                                        ...
                                                        <form method="post" action="<?php echo e(surl('setting/'.$userAccountInfo->id)); ?>">
                                                            <?php echo e(csrf_field()); ?>

                                                            <div class="form-group ">
                                                                <input type="text" id="input" value="<?php echo e($userAccountInfo->user_name); ?>" name="user_name" required="required"/>
                                                                <label class="control-label" for="input">user Name</label><i class="mtrl-select"></i>
                                                            </div>

                                                            <div class="form-group ">
                                                                <input type="text" value="<?php echo e($userAccountInfo->display_name); ?>" name="display_name"   required="required"/>
                                                            ...
                                                            <div class="form-group">
                                                                <textarea rows="4" id="textarea" name="about" > <?php echo e($userAccountInfo->about); ?> </textarea>
