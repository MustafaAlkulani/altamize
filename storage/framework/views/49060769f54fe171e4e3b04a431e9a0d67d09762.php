        ...
        <div class="container-fluid">
            ...
            <div class="row" id="page-contents">
                ...
                <div class="col-md-8 center-block">
                    ...
                    <?php if(  $block==0 And ($userProfileId==social()->user()->id  or $Cource_id!=0)): ?>
    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="bodyUpdateComment">
                ...
                <button type="button" id="UpdateCommentButtonSave">  <?php echo e(trans('social.Edit')); ?></button>
    ...
    <div class="modal-dialog  modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="bodyUpdateReplayComment">
                ...
                <button type="button" id="UpdateReplayCommentButtonSave"> <?php echo e(trans('social.Edit')); ?></button>
