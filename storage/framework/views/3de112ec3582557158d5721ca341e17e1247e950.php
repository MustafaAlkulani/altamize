...
<?php $__env->startSection('content'); ?>
    ...
    <center>
        ...
        <div style="width:350px;height: 350px; border: 1px solid whitesmoke ;text-align: center;position: relative" id="image">
            <img width="100%" height="100%" id="preview_image" src="<?php echo e(asset('uploads/noimage.jpg')); ?>"/>
        ...
        function upload(img) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.fail) {
                        $('#preview_image').attr('src', '<?php echo e(asset('uploads/noimage.jpg')); ?>');
                        alert(data.errors['file']);
                    }
                    else {
                        $('#file_name').val(data);

                        $('#preview_image').attr('src', 'http://127.0.0.1:8000/storage/'+data );
                    }
