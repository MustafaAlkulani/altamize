                    ...
                    <ul class="more-dropdown">
                        <li>
                            <a class="buttonDeletePost" url='<?php echo e($deletePostUrl); ?>'
                               message="do you want to delete this post" type="Profile" post-id="<?php echo e($post->id); ?>">Delete
                                Post <i
                        ...
                        <?php if(social()->user()->id == $post->user->id ): ?>
                            <li>
                                ...
                                <a post-id="<?php echo e($post->id); ?>" id="<?php echo e($post->id); ?>" class="buttonD">Edit Post.. </a>
                            </li>
