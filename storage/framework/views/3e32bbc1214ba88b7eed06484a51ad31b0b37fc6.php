                    ...
                    <?php if(isGroupAdmin(social()->user()->id,$Cource_id)==1): ?>
                        <div class="box-footer with-border">
                            <div class="text-center  assignmentInfoBtn">
                                <button class="btn btn-primary btn-block"> add Memeber <i class="fa fa-plus"></i>
                                </button>
                            </div>
                    ...
                    <div class="central-meta">
                        <div class="frnds">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item"><a class="active" href="#frends" data-toggle="tab"> Members</a>
                                    <span id="UnBlockCount" class="contFrinds1"><?php echo e($memberUNBlocked); ?></span></li>
                                <li class="nav-item"><a class="" href="#frends-req" data-toggle="tab">Blocked
                                        Members</a><span id="BlockCount" class="contFrinds2"><?php echo e($memberBlocked); ?></span></li>
                            </ul>
