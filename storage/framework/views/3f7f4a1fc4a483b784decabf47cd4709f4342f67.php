                            ...
                            <?php echo $__env->make("social.includes.newAssiggnment", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
                                ...
                                <div class="box box-solid collapsed-box">
                                    ...
                                    <div class="box-header with-border">
                                        <h3 class="box-title">التكليف <span> </span> </h3>
                                        <h5 class="box-title-date"><?php echo e($s->created_at->diffForHumans()); ?></h5>
                                        <div class="box-tools">
                                    ...
                                    <div class="box-body no-padding" >
                                        <ul class="nav nav-pills nav-stacked " style="display: block;">
                                            <?php $__currentLoopData = $s->solutionAssignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solutionAssignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
