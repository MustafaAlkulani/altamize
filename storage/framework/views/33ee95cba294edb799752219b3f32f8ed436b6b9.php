                                    ...
                                    <div class="box-body no-padding" >
                                        <ul class="nav nav-pills nav-stacked " style="display: block;">
                                            <li class="row " style="alignment: left;">
                                                <div class="col-xs-4"> <a href="#" class="btn">  <?php echo e($assignment->originalName); ?></a></div>

                                                <div class="col-xs-3"> <a   href=<?php echo e(surl('downloadTeaherAssignment/'.$assignment->id.'/'.$counter)); ?> class="btn">  <span class="fa fa-cloud-download "></span> </a></div>
                                                <div class="col-xs-1 SoulassignmentInfoBtn"> <a  class="btn  ">  <span class="fa fa-info "></span>  </a></div>

                                                <div class="col-xs-1">
                                                    <button href="<?php echo e(surl('editBook/Assignment/'.$assignment->id)); ?>" book-id="info<?php echo e($assignment->id); ?>" info="<?php echo e($assignment->describtion); ?>" class="btn btn-info buttonUpdateBook"> <i class="fa fa-edit"></i>
                                                    </button>
                                                </div>

                                                <div class="col-xs-1">

                                                    <button type="button"  class="btn btn-danger buttonDeleteBook "   book-id="<?php echo e($assignment->id); ?>"  booktype="Assignment" deleteMessage="do you want delete this  Assignment" > <i class="fa fa-trash"></i>  </button>
                                                </div>
                                        ...
                                        <?php $__currentLoopData = $assignment->solutionAssignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solutionAssignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li class="row " style="alignment: left;">
                                                <div class="col-xs-4"> <a href="#" class="btn"> <?php echo e($solutionAssignment->student->name); ?>   </a> </div>
                                                <div class="col-xs-2"> <a href="#" class="btn"> <?php echo e($solutionAssignment->originalName); ?>   </a> </div>



                                                <div class="col-xs-2"> <a href=<?php echo e(surl('download/'.$solutionAssignment->id.'/'.$counter)); ?> class="btn">  <span class="fa fa-cloud-download "></span> </a></div>
                                                <div class="col-xs-1"> <button class="btn check" uid="<?php echo e($solutionAssignment->id); ?>">  <span class="fa  <?php if($solutionAssignment->viewed==true): ?>
                                                                fa-check
                                                                <?php else: ?>
                                                                fa-bell
                                                ...
                                                <div class="col-xs-1">
                                                    <button href="<?php echo e(surl('editBook/SolutionAssignment/'.$solutionAssignment->id)); ?>" book-id="info<?php echo e($solutionAssignment->id); ?>" info="<?php echo e($solutionAssignment->describtion); ?>" class="btn btn-info buttonUpdateBook"> <i class="fa fa-edit"></i>
                                                    </button>
                                                </div>
                                                <div class="col-xs-1">
                                                    <button type="button"  class="btn btn-danger buttonDeleteBook "   book-id="<?php echo e($solutionAssignment->id); ?>"  booktype="SolutionAssignment" deleteMessage="do you want delete this  Solution Assignment" > <i class="fa fa-trash"></i>  </button>
                                                </div>
