        ...
        <div class="more"><big><big>...</big></big>
            <ul class="more-dropdown">
                <li>
                    ...
                    <a class="buttonUpdateReplayComment" url="<?php echo e(surl('editReplayComment/Profile/'.$replayComment->id)); ?>"
                       comment-id="ReplayCommentText<?php echo e($replayComment->id); ?>" info="<?php echo e($replayComment->text); ?>">Edit comment
                ...
                <li>
                    <a class="buttonDeleteReplyComment" url='<?php echo e(surl("deleteReplyComment/Profile/".$replayComment->id)); ?>'
                       ...
                       replay-id="<?php echo e($replayComment->id); ?>">Delete replay comment <i
...
<!-- end post options  -->
    ...
    <div class="we-comment">
        <div class="coment-head">
            <h5><a href="<?php echo e(surl('personalPage/'.$replayComment->user_id)); ?>"
                   title=""><?php echo e($replayComment->user->display_name); ?></a></h5>
