                            ...
                            <li>
                                ...
                                <?php if(social()->user()->useraccountable_type!="App\Student"): ?>
                                    <a <?php if($active=="assignment"): ?><?php echo e('class=active'); ?> <?php endif; ?> href="<?php echo e(surl('myCource/assignment/'.$Cource_id)); ?>"
                                       title="" data-ripple="">Assignment</a>
                                <?php endif; ?>
                                <?php if(social()->user()->useraccountable_type=="App\Student"): ?>
                                    <a <?php if($active=="studentAssignment"): ?><?php echo e('class=active'); ?> <?php endif; ?> href="<?php echo e(surl('myCource/StudentAssignmentAssignment/'.$Cource_id)); ?>"
                                       title="" data-ripple="">student Assignment </a>
                                <?php endif; ?>
