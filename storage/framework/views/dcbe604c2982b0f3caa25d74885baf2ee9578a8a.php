                            ...
                            <?php echo e(csrf_field()); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 dynamic" name="year" id="year" value="<?php echo e(old('year')); ?>"  style="width: 100%;" >
                                        ...
                                        <?php $__currentLoopData = App\Years::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
