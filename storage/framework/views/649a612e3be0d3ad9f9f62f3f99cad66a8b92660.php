                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="more col-xs-12">
                                            <li id="sidebar-user-box" class="user" uid="<?php echo e($user->id); ?>" >
                                                <figure>
                                                    <img  class="user_image" src="<?php echo e(Storage::url($user->personal_image)); ?>"  style="width:100px " alt="">
                                                    

                                                    <span  id="user_status_user_<?php echo e($user->id); ?>" class="user_status user_<?php echo e($user->id); ?>"></span>
                                                </figure>
                                            ...
                                            <ul class="more-dropdown  UserMassager-dropdown" >
                                                <div class="setting-row">
                                                    <span >  <a href="<?php echo e(surl('personalPage/'.$user->id)); ?>" >View Profile</a></span>
                                                ...
                                                <div class="setting-row">
                                                    ...
                                                    <input  class="<?php if(isBlokedUser(social()->user()->id,$user->id) ): ?>blocked<?php
                                                    $isBlocked=true ;
                                                    ...
                                                    <label for="switch<?php echo e($user->id); ?>" data-on-label="ON" data-off-label="OFF"></label>
                                                </div>

                                                <div class="setting-row">
                                                    <span > <a href="#"  post-id="" id=""  class="buttonD" >Edit Post </a></span>
                                                ...
                                                <div class="setting-row">
                                                    <span >  <a class="buttonDeleteConversation" url="deleteAllMessages"
                                                                message="do you want to delete this post"  user-id="<?php echo e($user->id); ?>">Delete Conversation
...
<?php $__env->startSection('footer'); ?>
    ...
    <script src="<?php echo e(url('/')); ?>/Desing/social/LowgaChat-design/js/script2.js"></script>
...
//                        $('#loadMoreMessagesButton').remove();
            ...
            function makeMassageAsReaded(id) {
                ...
                var url='/social/makeMassageAsReaded';
        ...
        $(document).on('click','.btnDeleteMessage',function () {
                ...
                Swal.fire({   title: message,
                    ...
                    if (result.value)
                    {
                        ...
                        var data='id='+encodeURIComponent(id )  ;
                        var url='/social/deleteMessage/'+id;
