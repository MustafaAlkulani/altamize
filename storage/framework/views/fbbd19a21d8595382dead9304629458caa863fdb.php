                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active fade show user_fllower_list " id="frends" >
                                        ...
                                        <div class="lodmore">
                                            ...
                                            <button id="loadMoreSearchResult" class="loadMoreSearchResult btn-view btn-load-more" searchWord="<?php echo e($searchWord); ?>" last-id="<?php echo e($last_id=$user->id); ?>" ></button>
