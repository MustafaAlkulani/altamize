                ...
                <div class=" col-md-8 center-block ">
                    ...
                    <div class="box-footer with-border">
                        <div class="text-center  assignmentInfoBtn">
                            <button  class="btn btn-primary btn-block"  >  add Memeber <i class="fa fa-plus"></i> </button>
                        </div>
                    ...
                    <div class="central-meta">
                                    <div class="frnds">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item"><a class="active" href="#frends" data-toggle="tab"> Members</a> <span id="UnBlockCount"><?php echo e($memberUNBlocked); ?></span></li>
                                            <li class="nav-item"><a class="" href="#frends-req" data-toggle="tab">Blocked Members</a><span id="BlockCount"><?php echo e($memberBlocked); ?></span></li>
                                        </ul>
                                                            ...
                                                            <div class="pepl-info">
                                                                ...
                                                                <span><?php if($groupMember->pivot->isAdmin): ?>
                                                                    ...
                                                                    <?php else: ?>
                                                                        ...
                                                                        <?php endif; ?></span>
                                                                <?php if(isGroupAdmin(social()->user()->id,$Cource_id)==1): ?>
                                                                <a title=""  user_id="<?php echo e($groupMember->id); ?>"  typeBlock="block" class="add-butn btn_blocked " data-ripple="">block</a>
                                                                <a title=""  user_id="<?php echo e($groupMember->id); ?>"  count-id="UnBlockCount" class="add-butn btn_deleteMember more-action" data-ripple="">Remove </a>
                                                          <?php endif; ?>
                                                            </div>
                                                        </div>
                                                    </li>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="lodmore">
                                                    ...
                                                    <button id="Btn_Ifollow" user-id=""  class="loadMoreFollowButton btn-view btn-load-more" type_follow="Ifollow"   last-id="0" ></button>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="nearly-pepls">
                                                            ...
                                                            <div class="pepl-info">
                                                                ...
                                                                <span><?php if($groupMember->pivot->isAdmin==1): ?>
                                                                    ...
                                                                    <?php endif; ?></span>
                                                                <?php if(isGroupAdmin(social()->user()->id,$Cource_id)==1): ?>
                                                                <a title=""  user_id="<?php echo e($groupMember->id); ?>"  typeBlock="unBlock" class="add-butn btn_blocked " data-ripple="">UnBlock</a>
                                                                <a title=""  user_id="<?php echo e($groupMember->id); ?>"  count-id="BlockCount"  class="add-butn btn_deleteMember more-action" data-ripple="">Remove </a>
