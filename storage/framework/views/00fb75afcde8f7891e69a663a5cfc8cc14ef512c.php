                            ...
                            <div class="frnds"> .
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a class="active" href="#frends" data-toggle="tab">
                                            <?php echo e(trans('social.NumResult')); ?>

                                             <?php echo e($usersCount); ?>    <?php echo e(trans('social.result')); ?>  </a></li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active fade show user_fllower_list " id="frends">
                                        <ul id="UlSearchResult" class="nearby-contct">
                                            <?php if($usersCount==0): ?>
                                                <p class="text-center" style="color: #00a7d0"> <?php echo e(trans('social.thereisnoresult')); ?> </p>
                                            <?php endif; ?>
...
<?php $__env->startSection('footer'); ?>
    <script>
        ...
        $(document).on('click', '.loadMoreSearchResult', function () {
            ...
            var url =$('#surl').val()+'/loadMoreSearchResult';
            //data=  data.serialize();
                ...
                beforsend: function () {
                    ...
                    if (data.status == true) {
                        if (data.users == '') {
                            ...
                            _this.remove();
                            _this_parent.append('<p class="text-center" style="color: #00a7d0"> <?php echo e(trans("social.thereisnoresult")); ?> </p>')
