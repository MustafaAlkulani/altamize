    ...
    <div class="topbar stick">
        ...
        <div class="top-area">
            <ul class="main-menu">
                ...
                <li class="Mydrowpdown "><a href="#" title="Languages" data-ripple=""><i class="fa fa-globe"></i></a>
                    <div  class="dropdowns">
                        <a href="admin" title=""><i <?php if(session()->get('lang')=="en"): ?> <?php echo e('class="ti-check"'); ?> <?php endif; ?> ></i>English</a>
                        <a href="admin/lang/ar" title=""><i <?php if(session()->get('lang')=="ar"): ?> <?php echo e('class="ti-check"'); ?> <?php endif; ?> ></i>Arabic</a>
                        ...
                        <li>
                            ...
                            <ul class="tow-sub-main-menu">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="<?php echo e(surl('reference/'.$department->name.'/'.$level.'/s1')); ?>" title="">symster 1</a></li>
                                        <li><a href="<?php echo e(surl('reference/'.$department->name.'/'.$level.'/s2')); ?>" title="">symster 2</a></li>
            ...
            <div class="user-img">
                <img src="<?php echo e(url('/')); ?>/images/resources/admin.jpg" alt="">
                <span class="status f-online"></span>
                <div class="user-setting">
