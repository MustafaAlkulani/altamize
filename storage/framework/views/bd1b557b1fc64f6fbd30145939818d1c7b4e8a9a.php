                            ...
                            <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="box box-solid collapsed-box">
                                    ...
                                    <div class="box-header with-border">
                                        <h3 class="box-title">   <?php echo e(trans('social.assignment')); ?><span><?php echo e($counter); ?> </span></h3>
                                    ...
                                    <div class="box-body no-padding">
                                        <ul class="nav nav-pills nav-stacked " style="display: block;">
                                            <li class="row " style="alignment: left;">
                                                <div class="col-xs-4"><a href="#" class="btn">  <?php echo e($assignment->originalName); ?></a>
                                                </div>
                                            ...
                                            <li class="row " style="alignment: left;">
                                                <h4 class="text-center">   <?php echo e(trans('social.studentSolution')); ?> </h4>
...
<?php endif; ?>   "></span></button>
                                                    ...
                                                    <div class="col-xs-12 assignmentInfoText vv ">
                                                        <p><?php echo e(trans('social.delverAt')); ?>:
                        ...
                        <?php else: ?>
                            <h4 class="text-center" style="color: #00a7d0">
                                <?php echo e(trans('social.noAssignment')); ?> </h4>
                        <?php endif; ?>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="bodyUpdateBook">
                        ...
                        <button type="button" id="UpdateBookButtonSave"> <?php echo e(trans('social.Edit')); ?></button>
