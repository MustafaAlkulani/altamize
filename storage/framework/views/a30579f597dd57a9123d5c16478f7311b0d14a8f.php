            ...
            <div class="container">
                ...
                <div class="row">
                     ...
                     <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(strpos($dept->vision ,$query)  ): ?>
                                <div class=" col-xs-12 ">
                                    ...
                                    <div class="condition-box">
                                        <h3 class="p-title"> <span> قسم  <?php echo e($dept->name); ?> >></span>  عن القسم</h3>
                    ...
                    <div class=" col-xs-12 ">
                        ...
                        <div class="condition-box">
                            <h3 class="p-title"><span> قسم  <?php echo e($dept->name); ?> >></span>الرسوم الدراسية</h3>
                            <p >
                    ...
                    <div class=" col-xs-12 ">
                        ...
                        <div class="condition-box">
                            <h3 class="p-title"><span> قسم  <?php echo e($dept->name); ?> >></span> رسالتنا</h3>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class=" col-xs-12 ">
                        ...
                        <div class="condition-box">
                            <h3 class="p-title"><?php echo e($info->slug); ?></h3>
