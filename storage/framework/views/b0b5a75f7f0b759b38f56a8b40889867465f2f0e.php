...
<input type="hidden" id="surl" name="surl" value="<?php echo e(surl('')); ?>">
...
<div class="theme-layout">
    ...
    <div class="topbar stick row">
        ...
        <div class="logo col-xs-1 center-block" style=" ">
            <a title="" style="   padding-left: 1%; margin-left: 5%; " href=""><img src="<?php echo e(Storage::url('social/logo9.png')); ?>" alt=""></a>
        </div>
        ...
        <div class="col-xs-10">
            <div class="top-area row" style="width: 100%">
                <ul style="width: 57%; margin-top: -21px;" class="main-menu ">
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="<?php echo e(surl('lang/ar')); ?>" title="">
                                    <i <?php if(session()->get('lang')=="ar"): ?> style="color: #00a7d0" <?php endif; ?> > <?php echo e(trans('social.Arabic')); ?> </i>
                                </a>
                            </li>
                            <li><a href="<?php echo e(surl('lang/en')); ?>" title="">
                                    <i <?php if(session()->get('lang')=="en"): ?> style="color: #00a7d0" <?php endif; ?> > <?php echo e(trans('social.English')); ?> </i>
                                </a>
                            </li>
                                    ...
                                    <ul class="tow-sub-main-menu">
                                        <?php for($level=1 ; $level<=  $department->levels ;$level++ ): ?>
                                            <li>
                                                ...
                                                <a href="#" title=""> <?php echo e(trans('social.level')); ?> <?php echo e($level); ?></a>
                                                <ul>
                                                    <li>
                                                        <a href="<?php echo e(surl('reference/'.$department->name.'/'.$level.'/1')); ?>"
                                                           title=""><?php echo e(trans('social.semester1')); ?></a></li>
                                                    <li>
                                                        <a href="<?php echo e(surl('reference/'.$department->name.'/'.$level.'/2')); ?>"
                                                           title=""><?php echo e(trans('social.semester2')); ?></a></li>
                    ...
                    <li>
                        <a href="#" title=""><?php echo e(trans('social.Groups')); ?></a>
                        <ul>
                    ...
                    <?php if(social()->user()->useraccountable_type=="App\Teacher"): ?>
                        <li>
                            <a href="#" title=""><?php echo e(trans('social.assginment')); ?></a>
                            <ul>
                ...
                <ul style="width: 43%; font-size: 20px;" class="setting-area col-xs-2">
                    ...
                    <li style="width: 6%" class="Mydrowpdown">
                        ...
                        <div class="searched">
                            <form method="get" action="<?php echo e(surl('search')); ?>" class="form-search">
                    ...
                    <li class="Mydrowpdown">
                        ...
                        <div class="dropdowns">
                            ...
                            <a href="<?php echo e(surl('messenger2/'.social()->user()->id)); ?>" onclick="pp(this)" title=""
                               class="more-mesg"><?php echo e(trans('social.viewmore')); ?> </a>
                        </div>
                    </li>
                    <li class="Mydrowpdown">
                        <a href="#" title="Notification" data-ripple="">
                            ...
                            <?php if((social()->user()->unreadnotifications->count() >0)): ?>
                                <span
                        ...
                        <div class="dropdowns">
                            ...
                            <?php if(social()->user()->notifications->count()): ?>
                                ...
                                <span> <?php echo e(social()->user()->unreadnotifications->count()); ?> <?php echo e(trans('social.NewNotifications')); ?> </span>
                                <ul class="drops-menu">
                            ...
                            <?php else: ?>
                                <span> <?php echo e(trans('social.NoNotifications')); ?></span>

                            <?php endif; ?>
                                <a onclick="pp(this)" href="<?php echo e(surl('allnotification')); ?>" title="" class="more-mesg"><?php echo e(trans('social.viewmore')); ?></a>
                        </div>
                    </li>
    ...
    <div class="responsive-header">
        ...
        <div style="background: #4bb5ef" class="row mh-head second ">
            ...
            <form action="<?php echo e(surl('search')); ?>" class="mh-form col-xs-10">
                    ...
                    <div class="setting-area center-block list-unstyled row" style="font-size: 20px ;">
                        ...
                        <li class="  col-xs-3 Mydrowpdown">
                            ...
                            <div class="dropdowns">
                                                ...
                                                <li>
                                                    <a href="<?php echo e(surl('')); ?>" title="">
                                                        ...
                                                        <a class="" onclick="pp(this) "
                                                           ...
                                                           <?php if($notify->data['post_id']!=0   ): ?>
                                                           href="<?php echo e(surl('ccc/'.$notify->data['post_id'])); ?>"
                                ...
                                <?php endif; ?>
                                <a href="notifications.html" title="" class="more-mesg"><?php echo e(trans('social.viewmore')); ?></a>
                            </div>
                        </li>
        ...
        <nav id="menu" class="res-menu">
            <ul>
                <li><span> <?php echo e(trans('social.references')); ?></span>
                    <ul>
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li><span><?php echo e($department->name); ?></span>
                                <ul>
                                    <?php for($level=1 ; $level<=  $department->levels ;$level++ ): ?>
                                        <li><span>  <?php echo e(trans('social.level')); ?> <?php echo e($level); ?></span>
                                            <ul>
                ...
                <li><span> <?php echo e(trans('social.Groups')); ?></span>
                    <ul>
                ...
                <?php if(social()->user()->useraccountable_type=="App\Teacher"): ?>
                    ...
                    <li><span> <?php echo e(trans('social.Assignment')); ?></span>
                        <ul>
                            <?php $__currentLoopData = $myCources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $myCource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(surl('myCource/assignment/'.$myCource->id)); ?>"
                                       title=""><?php echo e($myCource->study_plan->name_ar); ?></a></li>
                ...
                <li><span> <?php echo e(trans('social.Langages')); ?></span>
                    <ul>
                        <li><a href="<?php echo e(surl('lang/ar')); ?>" title="">
                                <i <?php if(session()->get('lang')=="ar"): ?> style="color: #00a7d0" <?php endif; ?> >   <?php echo e(trans('social.Arabic')); ?></i>
                            </a>
                ...
                <div class="">
                    ...
                    <div class="setting-row">
                        <span><a href="<?php echo e(route('personalPages.setting')); ?>" onclick="pp(this)" title=""><i
                                        class="ti-settings"></i><?php echo e(trans('social.accountsetting')); ?></a></span>
                    </div>
                    <div class="setting-row">
                        <span><a href="<?php echo e(surl('logout')); ?>" onclick="pp(this)" title=""><i class="ti-power-off"></i> <?php echo e(trans('social.logout')); ?></a></span>
                    </div>
                </div>
            </div>
        </nav>
