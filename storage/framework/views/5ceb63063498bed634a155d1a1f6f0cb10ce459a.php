<li class="post-comment">
    ...
    <div class="post-comt-box">
        ...
        <form method="post" action="<?php echo e($CommentUrl); ?>" url="<?php echo e($CommentUrl); ?>" accept-charset="UTF-8"
              class="newReplayComment" commenttype="<?php echo e($commentType); ?>" enctype="multipart/form-data">
            
            <?php echo e(csrf_field()); ?>

            
            <label for="text"><?php echo e(trans('social.Text')); ?></label>
